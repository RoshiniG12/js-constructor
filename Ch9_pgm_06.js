var Planet = function (name, position, type) {
    ...
    this.getMoon = function (index) {
        if (index >= 0 && index < this.moons.length) {
            ...
            return "Moon index out of range.";
        }
    };
};
...
planet3.addMoon("Caloris Basin");

[ planet1, planet2, planet3 ].forEach(function (planet) {
    planet.showPlanet();
});

console.log("Getting moon at index 1 from planet1:", planet1.getMoon(1));
console.log("Getting moon at index 0 from planet2:", planet2.getMoon(0));
console.log("Getting moon at index 2 from planet3:", planet3.getMoon(2));
